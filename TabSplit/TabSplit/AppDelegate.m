...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TabSplit" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TabSplit.sqlite"];
...
- (BOOL)application:(UIApplication *)application handleOpenURL:(NSURL *)url {
    ...
    NSString* username = [query valueForKey:@"username"];
    NSString* token = [query valueForKey:@"token"];
    ...
    NSLog(@"Need to handle open URL for %@", url);
    return YES;
}
...
//	activityIndicator.center = [UIApplication sharedApplication];
//	[self.view addSubview: activityIndicator];
    NSLog(@"Handling login ...");
    //[self.window.rootViewController performSegueWithIdentifier:@"reloadData" sender:self.window.rootViewController];
}
+ (NSManagedObjectContext*) managedObjectContext {
